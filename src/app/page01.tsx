export default function Home() {
  return (
    <div className="p-4 bg-slate-50 text-slate-900 dark:bg-slate-900 dark:text-slate-100 h-screen flex flex-col items-center text-center">
        ...
        <button className="bg-sky-500 dark:bg-sky-400 dark:text-sky-950 px-4 py-2 rounded-md font-medium mt-4 enabled:hover:bg-sky-600 disabled:opacity-60 disabled:cursor-not-allowed">Sign in</button>
      </div>
    </div>
  )
}